...
ssh $SHORTCUT ${USER_MOSQUITTO_SERVER}@${HOST_MOSQUITTO} ~/create_mosquitto.sh $CA_KEY_FILE
...
ssh $SHORTCUT ${USER_TELEGRAF_SERVER}@${HOST_TELEGRAF} ~/create_telegraf.sh $CA_KEY_FILE
...
ssh $SHORTCUT ${USER_INFLUXDB_SERVER}@${HOST_INFLUXDB} ~/create_influxDB.sh $CA_KEY_FILE
...
ssh $SHORTCUT ${USER_GRAFANA_SERVER}@${HOST_GRAFANA} ~/create_grafana.sh $CA_KEY_FILE
